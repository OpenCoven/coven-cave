...
assert.match(src, /import \{ runRefreshSafely, useRefreshOnFocus \} from "@\/lib\/hooks\/use-refresh-on-focus"/, "composes the existing focus hook and its async rejection guard");
assert.match(
  src,
