...
export const SUITES = {
  ...
  api: [
    ...
    "scripts/sidecar-archive.test.mjs",
    "scripts/windows-installer-budget.test.mjs",
    "scripts/windows-installer-metrics.test.mjs",
    "scripts/windows-upgrade-smoke.test.mjs",
