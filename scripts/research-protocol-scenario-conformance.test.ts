...
test("covers every required Unit 0 cross-object scenario", () => {
  for (const requiredId of [
    ...
    "manifest.deadline-equal",
    "manifest.deadline-earlier",
    "manifest.deadline-extension-without-fresh-consent",
    "manifest.deadline-extension-with-fresh-consent",
    "manifest.deadline-renewal-without-anchor-advance",
    "manifest.deadline-renewal-beyond-policy",
    "manifest.null-deadline-to-2099",
    ...
    "research-run.manifest-before-run",
    "research-run.updated-before-manifest-finalization",
    "research-run.manifest-clock-equality",
    "research-run.retention-update-after-run",
    "research-run.post-final-retention-revision",
    ...
    "discovery.proposal-before-start",
    "discovery.proposal-at-start",
