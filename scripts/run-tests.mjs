...
export const SUITES = {
  app: [
    ...
    "src/components/role-surfaces/research-source-rows.test.ts",
    "src/components/role-surfaces/research-markdown-preview.test.ts",
    "src/components/role-surfaces/research-markdown-preview.behavior.test.tsx",
