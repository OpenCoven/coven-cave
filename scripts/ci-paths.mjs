...
const CLIENT_V1_PATH =
  /^(?:src\/lib\/server\/client-v1\/|src\/app\/api\/client\/v1\/|scripts\/(?:export-client-v1-contract|client-v1-release-smoke)(?:\.test)?\.mjs$|docs\/api\/client-v1(?:[./-]|$)|docs\/client-v1(?:[./-]|$)|\.gitattributes$)/;
