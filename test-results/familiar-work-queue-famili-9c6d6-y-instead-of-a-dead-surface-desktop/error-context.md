...
- Name: familiar-work-queue.spec.ts >> familiar work queue (PR control tower) >> PR bridge down at first load degrades to beads-only instead of a dead surface
- Location: tests/familiar-work-queue.spec.ts:268:7
