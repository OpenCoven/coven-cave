...
assert.match(route, /resolveNpxLaunchCommand\(\)/, "skills use resolves the Windows npx shim before spawning");
assert.match(route, /execFileAsync\(launch\.command, \[\.\.\.launch\.fixedArgs, \.\.\.args\]/, "skills use uses execFile argv arrays, not shell command strings");
