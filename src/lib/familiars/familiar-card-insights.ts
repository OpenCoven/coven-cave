...
import { deriveAnalyticsInsight, type AnalyticsInsight } from "@/lib/familiars/familiar-analytics-insight";
import type { GrowthSignal } from "@/lib/familiars/familiar-growth-signals";
