...
export const SUITES = {
  app: [
    ...
    "scripts/signed-registry-config.test.mjs",
    ...
    "src/lib/server/github-issue-queue.test.ts",
    ...
    "src/lib/pr-management.test.ts",
    "src/lib/work-queue.test.ts",
    ...
    "src/lib/proposal-review-blocks.test.ts",
    ...
    "src/components/proposal-review-card.test.tsx",
    "src/components/proposal-review-card-wiring.test.ts",
    ...
    "src/components/command-palette-search-lifecycle.test.tsx",
    ...
    "src/lib/scoped-composer-draft.test.ts",
    "src/lib/chat-browse-scope.test.ts",
    ...
    "src/lib/proposal-terminal.test.ts",
    "scripts/sanitize-threads-trace.test.mjs",
  ...
  "src/components/settings-general-data.test.tsx",
    ...
    "src/components/document-reader-markdown.test.ts",
    ...
    "src/components/dashboard/dashboard-loading.test.tsx",
