...
dependencies (`@opencoven/cli` 0.2.3 and `@opencoven/coven-code` 0.6.1 at
...
leg builds the exact signed `v0.2.3` source tag at commit
`6804780d0fbbba44b27718d6534aec09a5230218` with Cargo's locked dependency
