...
export const PREREQUISITES: readonly PrerequisiteDefinition[] = [
  ...
  },
  {
    ...
    probe: "npm-package",
    install: { kind: "managed-npm", package: npmPackage("@opencoven/cli", "0.2.5", "sha512-qZ9nn1MsEf0P4fGHLezaX95VepBnY3dQPBPwcrmBJuFeCt5CeIYA/EVKPalfaSwWAAFj8J0YLugkBALH4JKdDw==", "coven") },
    requiresPrivilege: false,
    restart: "none",
