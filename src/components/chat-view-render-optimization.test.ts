...
assert.match(
  chatViewSource,
  /const canonicalText = liveGeneration\.responseText\.append\(text\);[\s\S]*?text: canonicalText/,
  "streaming append publishes the incrementally normalized canonical buffer",
);
