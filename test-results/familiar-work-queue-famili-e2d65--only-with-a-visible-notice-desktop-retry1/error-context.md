...
- Name: familiar-work-queue.spec.ts >> familiar work queue (PR control tower) >> beads adapter failure degrades to PRs-only with a visible notice
- Location: tests/familiar-work-queue.spec.ts:195:7
