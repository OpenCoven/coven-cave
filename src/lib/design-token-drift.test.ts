...
const BASELINES = {
  ...
  offScaleSpacingPx: 1352, // off-4px-grid pad/margin/gap components (2px/6px/10px/…) — +3: the queue triage toolbar copies the compact control-band metrics (6px group gaps, 10px band pad) so its density matches the lane headers it filters
