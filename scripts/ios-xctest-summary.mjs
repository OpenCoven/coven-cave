...
export const QUARANTINED_FAILURES = new Map([
  // ── Repaired by #4958 (cave-vz17i); delete these when it lands ───────────
  [
    "testTheRequestEscapesTheIdAndAsksForTheVersionItUnderstands",
    {
      bead: "cave-uirka",
      reason: "CaveClient double percent-encodes a familiar id containing '/'. Repaired by #4958.",
      expires: "2026-09-13",
    },
  ],
  [
    "testATwoHundredThatSaysOkFalseIsNotASuccess",
    {
      bead: "cave-uirka",
      reason: "A 200 whose envelope says ok:false is reported as a decode error. Repaired by #4958.",
      expires: "2026-09-13",
    },
  ],
  [
    "testUpdateTaskProjectPatchesProjectIdThroughBoardHelper",
    {
      bead: "cave-vz17i",
      reason: "URLProtocol stubs see httpBodyStream, not httpBody. Repaired by #4958.",
      expires: "2026-09-13",
    },
  ],
  [
    "testStartVoiceConversationUsesProjectRootContract",
    {
      bead: "cave-vz17i",
      reason: "URLProtocol stubs see httpBodyStream, not httpBody. Repaired by #4958.",
      expires: "2026-09-13",
  ...
  [
    "testRequestOpenCanonicalizesNestedWorktreeRootToRegisteredProject",
    { bead: "cave-vz17i", reason: "requestOpen re-resolves the thread from app.threads; the test never seeded it. Repaired by #4958.", expires: "2026-09-13" },
  ],
  [
    "testRequestOpenDoesNotSwitchProjectWhenContextAlreadyMatches",
    { bead: "cave-vz17i", reason: "requestOpen re-resolves the thread from app.threads; the test never seeded it. Repaired by #4958.", expires: "2026-09-13" },
  ],
  [
    "testRequestOpenFailsExplicitlyWhenProjectMetadataIsInvalid",
    { bead: "cave-vz17i", reason: "requestOpen re-resolves the thread from app.threads; the test never seeded it. Repaired by #4958.", expires: "2026-09-13" },
  ],
  [
  ...
  [
    "testRequestOpenSwitchesToUnassignedForProjectlessThread",
    { bead: "cave-vz17i", reason: "requestOpen re-resolves the thread from app.threads; the test never seeded it. Repaired by #4958.", expires: "2026-09-13" },
  ],
  [
    "testRequestOpenTreatsUnknownAndDeletedRootsAsUnassigned",
    { bead: "cave-vz17i", reason: "requestOpen re-resolves the thread from app.threads; the test never seeded it. Repaired by #4958.", expires: "2026-09-13" },
  ],
  [
    "testReconnectPendingSessionHydrationSupersedesStaleGenerationWithoutRetryLoop",
    { bead: "cave-vz17i", reason: "The test asserts toast == nil across a reconnection that deliberately posts 'Reconnected to Cave'. Repaired by #4958.", expires: "2026-09-13" },
  ],
  [
    "testReconnectPendingTaskHydrationSupersedesStaleGenerationWithoutRetryLoop",
    { bead: "cave-vz17i", reason: "The test asserts toast == nil across a reconnection that deliberately posts 'Reconnected to Cave'. Repaired by #4958.", expires: "2026-09-13" },
  ],
