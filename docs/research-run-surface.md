...
When backed by a canonical mission, the inline card may issue the same mission actions as the Desk:
...
- Pause, resume, and stop use labeled buttons rather than icon-only state changes.
