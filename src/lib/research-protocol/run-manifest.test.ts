...
test("canonical public HTTP URL predicate follows the parser contract", () => {
  for (const canonicalUrl of [
    ...
    "https://xn--r8jz45g.xn--zckzah:8443/%E6%A4%9C%E7%B4%A2?q=%E7%8C%AB#%E8%A8%BC%E6%8B%A0",
  ]) {
  ...
  for (const canonicalUrl of [
    ...
    "https://EXAMPLE.test/research",
    "https://example.test:443/research",
    "http://example.test:80/research",
    "https://example.test/a/../research",
    "https://example.test",
    "https://example.test:/research",
    "https://例え.テスト/検索?q=猫",
...
test("public evidence canonical URLs reject non-HTTP, non-lexical, malformed, whitespace, and credential-bearing values", () => {
  ...
  for (const [canonicalUrl] of [
    ...
    ["https://EXAMPLE.test/research", false],
    ["https://example.test:443/research", false],
    ["http://example.test:80/research", false],
    ["https://example.test/a/../research", false],
    ["https://example.test", false],
    ["https://example.test:/research", false],
    ["https://例え.テスト/検索?q=猫", false],
    ...
    ["https://example.test/\u007fresearch", false],
    ["https://example.test/%", false],
    ["https://example.test/%2", false],
    ["https://example.test/%GG", false],
    ["https://", true],
