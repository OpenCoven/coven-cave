...
const mutationSource = readFileSync(new URL("../projects/project-registry-mutation.ts", import.meta.url), "utf8");
const errorsSource = readFileSync(new URL("../projects/project-errors.ts", import.meta.url), "utf8");
