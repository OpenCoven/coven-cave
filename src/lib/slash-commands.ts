...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: "/research", hint: "start a research run", description: "Start a research run from this chat. It runs in the Research desk — which can open this conversation again — while you carry on here.", argPlaceholder: "what to research…", section: "chat" },
  ...
  { name: "/diagram", hint: "design a diagram", description: "Start a guided diagram session and generate an accessible HTML/SVG artifact.", argPlaceholder: "what to diagram…", section: "chat" },
