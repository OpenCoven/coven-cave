...
// Normal navigation hydrates fully closed, then restores the shared 240px
...
// Full collapse must survive the px conversion.
assert.match(
  shell,
  /collapsedSize=\{NAV_COLLAPSED_PX\}/,
  "every desktop and mobile nav closes fully",
);
assert.match(
  shell,
