...
send/retry assertions passed along with the attachment library, harness-routing,
and offline-queue probes. Targeted ESLint, TypeScript typecheck, and
`git diff --check` exited 0. Changes remain uncommitted pending Val's approval.
