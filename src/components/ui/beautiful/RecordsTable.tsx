...
const STRENGTH: Record<Strength, { label: string; color: string; rank: number }> = {
  strong: { label: "Very strong", color: "var(--bui-green)", rank: 3 },
  weak: { label: "Weak", color: "var(--bui-orange)", rank: 2 },
  veryweak: { label: "Very weak", color: "var(--bui-red)", rank: 1 },
