...
// cave-n83q3 banks the Review Deck's retired legacy CSS (-15 off-scale
// spacing values) and replaces its inline progress width with <progress> (-1).
BASELINES.offScaleSpacingPx = 1626;
