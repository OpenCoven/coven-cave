...
- Name: familiar-work-queue.spec.ts >> familiar work queue (PR control tower) >> Attention strip surfaces stale and unlinked open PRs
- Location: tests/familiar-work-queue.spec.ts:178:7
