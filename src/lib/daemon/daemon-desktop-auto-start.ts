import { createFamiliarLivenessPolicy } from "@/lib/familiars/familiar-liveness";
import type { DaemonStatusPollResult } from "@/lib/daemon/daemon-status-classification";
...
export function createDaemonDesktopAutoStartCoordinator(
  ...
  // src/lib/familiars/familiar-liveness.ts for why "N attempts then never" was wrong.
