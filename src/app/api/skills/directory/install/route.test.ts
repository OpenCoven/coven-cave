...
assert.match(route, /resolveNpxLaunchCommand\(\)/, "installer resolves the Windows npx shim before spawning");
assert.match(route, /execFileAsync\(launch\.command, \[\.\.\.launch\.fixedArgs, \.\.\.args\]/, "installer uses execFile argv arrays, not shell command strings");
