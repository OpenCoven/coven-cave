...
- Name: familiar-work-queue.spec.ts >> familiar work queue (PR control tower) >> renders lanes from the beads + PR bridge and exposes cleanup/claim actions
- Location: tests/familiar-work-queue.spec.ts:72:7
