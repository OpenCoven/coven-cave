...
- wip(cave-9om1-ios-performance-closeout): preserve uncommitted work before worktree retirement
- docs(onboarding): baseline the desktop journey
...
- WIP: active chat siderail highlight
...
- wip: composer handoff in-progress state
