...
- `.agents/skills/branch-curator/evals/evals.json` covers authorization scope,
  race handling, protected/live preservation, local versus remote authority,
  and the unchanged automatic gate;
