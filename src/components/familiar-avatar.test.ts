...
assert.match(source, /canResolveWorkspaceAvatar/, "Must guard convertFileSrc behind a Tauri-runtime check");
assert.match(source, /avatarAssetUrl/, "Must cache-bust direct asset URLs through the helper");
